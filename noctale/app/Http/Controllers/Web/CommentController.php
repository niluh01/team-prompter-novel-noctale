...
class CommentController extends Controller
{
    ...
    public function adminDestroy(Comment $comment)
    {
        ...
        $comment->update(['is_deleted_by_admin' => true]);

        return back()->with('success', 'Komentar telah dihapus oleh Admin.');
    }

    public function toggleLike(\App\Models\Comment $comment)
    {
        $like = $comment->likes()->where('user_id', \Illuminate\Support\Facades\Auth::id())->first();
